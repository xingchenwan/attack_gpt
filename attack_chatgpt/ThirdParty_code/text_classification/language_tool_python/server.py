...
class LanguageTool:
    ...
    def __init__(self,  language=None, cache_path=None, motherTongue=None,
    ...
    def _start_local_server(self):
        ...
        try:
            ...
            server_cmd = get_server_cmd(self._cache_path, self._port, self.config)
